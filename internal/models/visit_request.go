...
type VisitRequest struct {
	...
	ReminderOptIn         bool       `gorm:"not null;default:true" json:"reminderOptIn"`
	...
	ConfirmationClaimedAt *time.Time `gorm:"index" json:"-"`
	ReminderSentAt        *time.Time `gorm:"index" json:"reminderSentAt,omitempty"`
	ReminderClaimedAt     *time.Time `gorm:"index" json:"-"`
	FollowUpClaimedAt     *time.Time `gorm:"index" json:"-"`
