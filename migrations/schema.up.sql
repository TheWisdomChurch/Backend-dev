...
-- whether we are still allowed to reach out. Becomes the single source for the
-- "anniversary" celebration kind. The legacy leadership_members /
-- workforce_members anniversary_month/day columns are left in place and
-- backfilled below; a later migration can drop them.
